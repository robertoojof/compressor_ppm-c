 ...
 */
 ...
 class BitInputStream final {
     ...
     // Returns the current byte being read (0-255) or -1 if EOF
     public: int getCurrentByte() const;
     
     // Returns the number of bits remaining in the current byte (0-7)
     public: int getNumBitsRemaining() const;
